...
namespace kubvc::render {
	...
	void GUI::applyDefaultKubDarkTheme() {
		...
		style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.60f, 0.60f, 0.60f, 1.00f);
		...
		style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.35f, 0.35f, 0.35f, 0.67f);
		style.Colors[ImGuiCol_ResizeGripActive] = ImVec4(0.45f, 0.45f, 0.45f, 0.95f);
		...
		style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.15f, 0.08f, 0.08f, 0.97f);
		style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.35f, 0.12f, 0.12f, 1.00f);
		style.Colors[ImGuiCol_PlotLines] = ImVec4(0.61f, 0.61f, 0.61f, 1.00f);
		style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.00f, 0.43f, 0.35f, 1.00f);
		style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.90f, 0.30f, 0.30f, 1.00f);
		style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.00f, 0.40f, 0.40f, 1.00f);
		...
		plotStyle.Colors[ImPlotCol_Fill] = ImVec4(0.25f, 0.25f, 0.25f, 0.50f);
		plotStyle.Colors[ImPlotCol_MarkerOutline] = ImVec4(0.80f, 0.80f, 0.80f, 1.00f);
		plotStyle.Colors[ImPlotCol_MarkerFill] = ImVec4(0.25f, 0.25f, 0.25f, 0.50f);
		plotStyle.Colors[ImPlotCol_PlotBg] = ImVec4(0.08f, 0.08f, 0.08f, 1.00f);
		plotStyle.Colors[ImPlotCol_PlotBorder] = ImVec4(0.30f, 0.30f, 0.30f, 0.50f);
		plotStyle.Colors[ImPlotCol_Selection] = ImVec4(0.90f, 0.30f, 0.30f, 1.00f);
		plotStyle.Colors[ImPlotCol_Crosshairs] = ImVec4(0.80f, 0.80f, 0.80f, 0.50f);
